...
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "Roleset", "SingleUnconnectedState", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    shared_ptr<::reasoner::ASPFactsQuery> queryObject = make_shared<::reasoner::ASPFactsQuery>(((::reasoner::ASPSolver*) (aspSolver->getSolver())), aspTerm);
    ...
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The state '" << brokenState->getName() << "' should be broken.";
    cout << queryObject->toString() << endl;
}

TEST_F(AspAlicaEngine, localInconsistentCardinalities)
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "Roleset", "LocalInconsistentCardinalities", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    cout << "Measured Grounding Time: " << std::chrono::duration_cast<chrono::milliseconds>(end - groundingStart).count() << " ms" << endl;
    cout << queryObject->toString() << endl;
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The EntryPoint '" << brokenEntryPoint->getId() << "' should be broken";
    cout << queryObject->toString() << endl;
}

TEST_F(AspAlicaEngine, taskTwiceInPlan)
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "Roleset", "TaskTwicePlan", ".", false)) << "Unable to initialise the ALICA Engine!";

    alica::reasoner::ASPSolverWrapper* aspSolver = dynamic_cast<alica::reasoner::ASPSolverWrapper*>(ae->getSolver(1)); // "1" for ASPSolver
    alica::Plan* plan = ae->getPlanBase()->getMasterPlan();

    string queryString = aspSolver->gen->brokenPlanTaskPair(plan, (alica::Task*) ::reasoner::IASPSolver::WILDCARD_POINTER, false);
...
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "Roleset", "UnconnectedStateMachine", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    shared_ptr<::reasoner::ASPFactsQuery> queryObject1 = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*) (aspSolver->getSolver())), constraint1);
    ...
    shared_ptr<::reasoner::ASPFactsQuery> queryObject2 = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*) (aspSolver->getSolver())), constraint2);
    ...
    shared_ptr<::reasoner::ASPFactsQuery> queryObject3 = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*) (aspSolver->getSolver())), constraint3);
    ...
    shared_ptr<::reasoner::ASPFactsQuery> queryObject4 = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*) (aspSolver->getSolver())), constraint4);
    ...
    EXPECT_TRUE(queryObject1->factsExistForAllModels()) << "The state '" << brokenState1->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject2->factsExistForAllModels()) << "The state '" << brokenState2->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject3->factsExistForAllModels()) << "The state '" << brokenState3->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject4->factsExistForAllModels()) << "The state '" << brokenState4->getName() << "' should be broken.";
...
TEST_F(AspAlicaEngine, hierarchicalInconsistentCardinalities)
{
    ...
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The running plan 'rp" << to_string(14695984337881541968ul) << "' should be broken.";
    cout << queryObject->toString() << endl;
}

TEST_F(AspAlicaEngine, cycleInPlan)
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "Roleset", "CyclePlanA", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_TRUE(queryObject1->factsExistForAllModels()) << "The plan '" << brokenPlan1->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject2->factsExistForAllModels()) << "The plan '" << brokenPlan2->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject3->factsExistForAllModels()) << "The plan '" << brokenPlan3->getName() << "' should be broken.";
    cout << queryObject1->toString() << endl;
    cout << queryObject2->toString() << endl;
    cout << queryObject3->toString() << endl;
}
...
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "UnconnectedSyncRoleset", "UnconnectedSynchronisations", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_TRUE(queryObject1->factsExistForAllModels()) << "The synchronisation '" << brokenSynchronisation1->getName() << "' should be broken.";
    EXPECT_TRUE(queryObject2->factsExistForAllModels()) << "The synchronisation '" << brokenSynchronisation2->getName() << "' should be broken.";
    cout << queryObject1->toString() << endl;
    cout << queryObject2->toString() << endl;
}
...
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "ReusePlanWithoutCycle", "ReusePlanWithoutCycle", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_FALSE(queryObject1->factsExistForAllModels()) << "The plan '" << brokenPlan->getName() << "' should NOT be broken.";
    EXPECT_FALSE(queryObject2->factsExistForAllModels()) << "The plan '" << brokenPlan->getName() << "' should NOT contain a cycle.";
    cout << queryObject1->toString() << endl;
    cout << queryObject2->toString() << endl;
}
...
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "ReusePlanWithoutCycle", "NonLocalInRelation", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The condition '" << nonLocalCondition->getName() << "' should be -local(cond).";
    cout << queryObject->toString() << endl;
}

TEST_F(AspAlicaEngine, indirectReusePlanInPlantype)
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "ReusePlanWithoutCycle", "IndirectReusePlanInPlantype", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The plan '" << plan->getName() << "' should contain a cycle.";
    cout << queryObject->toString() << endl;
}
...
TEST_F(AspAlicaEngine, reusePlanFromPlantypeWithoutCycle)
{
    ...
    EXPECT_TRUE(queryObject->factsExistForAllModels()) << "The plan '" << plan->getName() << "' should be free of cycles.";
    cout << queryObject->toString() << endl;
}

TEST_F(AspAlicaEngine, inconsistentCardinalities)
{
    EXPECT_TRUE(ae->init(bc, cc, uc, crc, "ReusePlanWithoutCycle", "InconsistentCardinalities", ".", false)) << "Unable to initialise the ALICA Engine!";
    ...
    EXPECT_TRUE(brokenRunningPlan1Object->factsExistForAllModels()) << "The query '" << brokenRunningPlan1 << "' should be true.";
    EXPECT_FALSE(brokenRunningPlan2Object->factsExistForAllModels()) << "The query '" << brokenRunningPlan2 << "' should be false.";
