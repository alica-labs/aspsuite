...
TEST_F(AspAlicaEngine, taskTwiceInPlan)
{
	...
	string queryString = aspSolver->gen->brokenPlanTaskPair(plan,
															(alica::Task*)::reasoner::IASPSolver::WILDCARD_POINTER,
															false);
...
TEST_F(AspAlicaEngine, inconsistentCardinalities)
{
	...
	constraint3->setType(::reasoner::ASPQueryType::Facts);
	shared_ptr<::reasoner::ASPFactsQuery> brokenRunningMasterPlanObject = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*)(aspSolver->getSolver())), constraint1);
	shared_ptr<::reasoner::ASPFactsQuery> brokenRunningPlan1Object = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*)(aspSolver->getSolver())), constraint2);
	shared_ptr<::reasoner::ASPFactsQuery> brokenRunningPlan2Object = make_shared<::reasoner::ASPFactsQuery>(((reasoner::ASPSolver*)(aspSolver->getSolver())), constraint3);
	...
	EXPECT_FALSE(brokenRunningMasterPlanObject->factsExistForAllModels()) << "The query '" << brokenRunningMasterPlan
