...
namespace kbcr {
    ...
    ConceptNetCall::ConceptNetCall(KnowledgebaseCreator *gui, QString id, QString queryConcept) {
        ...
        this->connect(this->collectSynonymConceptsNAM, SIGNAL(finished(QNetworkReply * )), this,
                      SLOT(collectConcepts(QNetworkReply * )));
        this->connect(this->collectAntonymConceptsNAM, SIGNAL(finished(QNetworkReply * )), this,
                      SLOT(mapAntonyms(QNetworkReply * )));
        this->connect(this->collectUsedForConceptsNAM, SIGNAL(finished(QNetworkReply * )), this,
                      SLOT(mapServices(QNetworkReply * )));
...
//        delete this->collectSynonymConceptsNAM;
    ...
    void ConceptNetCall::collectMotivatedByGoals() {
        for (auto motivatedConcepts : this->connectedConcepts) {
            ...
            QUrl url(KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYEND +
                     motivatedConcepts.first + "&rel=/r/UsedFor" + "&limit=1000");
            QEventLoop loop;
...
//								<< " keeping: " << it->first.toStdString() << std::endl;
    ...
    void ConceptNetCall::gatherConcepts(std::map<QString, std::shared_ptr<ConceptNetEdge>> toCheck) {
        ...
        for (auto adjective : toCheck) {
            ...
            QUrl urlIsA(KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYSTART +
                        adjective.first + "&rel=/r/IsA" + "&limit=1000");
            ...
            QUrl urlSynonym(
                    KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYSTART +
                    adjective.first + "&rel=/r/Synonym" + "&limit=1000");
            ...
            QUrl urlDefinedAs(
                    KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYSTART +
                    adjective.first + "&rel=/r/DefinedAs" + "&limit=1000");
            ...
            QUrl urlPartOf(
                    KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYSTART +
                    adjective.first + "&rel=/r/PartOf" + "&limit=1000");
    ...
    void ConceptNetCall::collectAntonyms() {
        for (auto adjective : this->connectedConcepts) {
            ...
            QUrl url(KnowledgebaseCreator::CONCEPTNET_BASE_URL + KnowledgebaseCreator::CONCEPTNET_URL_QUERYNODE +
                     adjective.first + "&rel=/r/Antonym" + "&limit=1000");
            QEventLoop loop;
            this->connect(this, SIGNAL(closeCollectLoop()), &loop, SLOT(quit()));
